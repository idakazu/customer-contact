...
# 従業員情報検索Tool定義
SEARCH_EMPLOYEE_TOOL_NAME = "search_employee_tool"
SEARCH_EMPLOYEE_TOOL_DESCRIPTION = "従業員の専門分野や対応履歴を検索したい時に使う"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - 【メンション先の選定理由】について、以下の条件に従って生成してください。
        - なぜこの担当者が選ばれたのか、その理由を詳細に説明してください。
        - 担当者の専門分野、過去の対応履歴、スキルなどを根拠として含めてください。
